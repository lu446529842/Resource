...
function check_error(){
  ...
  then
          ...
          error_info="command ${cmd_exec} fail ro execution  in function  ${func} ,exit status :${status} "
          echo ""
          echo "#===============ERROR LOG==============================================================="
        ...
        echo "command ${cmd_exec}   in function  ${func}  execution Successfully!!"
        echo ""
  fi
