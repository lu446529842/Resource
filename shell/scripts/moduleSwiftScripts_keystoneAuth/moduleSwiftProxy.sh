...
#====================================================================
#usage
# ./moduleSwiftProxy.sh param_1 param_2
# param_1 is a keystone auth server IP
# param_2 a subnet Prefix like 192.168 or 192.168.2 that you run this shell script in
#====================================================================
...
check_errorr "$?" "yum install python-keystoneclient -y" "install_python_keystoneclient"
sleep 1
}
...
#	configure_update_Repos
	...
	echo "params Error!"
	echo "you need to provide keystone auth server ip and a subnet Prefix like 192.168 or 192.168.2 that you run this shell script in  as  params !"
