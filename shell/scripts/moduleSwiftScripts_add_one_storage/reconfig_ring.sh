...
#				check_error "$?" "swift-ring-builder account.builder add z${ZONE}-${STORAGE_LOCAL_NET_IP}:6002/${DEVICE} ${WEIGHT}" "add_new_device"

                                swift-ring-builder container.builder add z${ZONE}-${STORAGE_LOCAL_NET_IP}:6001/${DEVICE} ${WEIGHT}
#				check_error "$?" "swift-ring-builder container.builder add z${ZONE}-${STORAGE_LOCAL_NET_IP}:6001/${DEVICE} ${WEIGHT}" "add_new_device"

                                swift-ring-builder object.builder add z${ZONE}-${STORAGE_LOCAL_NET_IP}:6000/${DEVICE} ${WEIGHT}
#				check_error "$?" "swift-ring-builder object.builder add z${ZONE}-${STORAGE_LOCAL_NET_IP}:6000/${DEVICE} ${WEIGHT}" "add_new_device"
