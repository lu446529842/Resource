...
#====================================================================
#usage 
#	./xxx.sh param_1 param_2 param_3
#	param_1 proxy server IP
#	param_2 a subnet Prefix like 192.168 or 192.168.2 
#	param_3 zone_id
#====================================================================
...
#	configure_update_Repos
	...
	echo "params Error !"
	echo "you need to provide proxyserver IP address and a subnet Prefix like 192.168 or 192.168.2 and storage zone_num"
	echo "here is the sample :./xxx.sh 192.168.0.51 192.168.2 1"
